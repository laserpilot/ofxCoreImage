...
#include "ofxCIMultiplyBlendMode.h"

void ofxCIMultiplyBlendMode::loadFilter(){
...
void ofxCIMultiplyBlendMode::update(ofTexture tex1, ofTexture tex2){ //blend 2 OF textures
...
//------------------------
void ofxCIMultiplyBlendMode::update(CIImage* inputImage, CIImage* inputBGImage){//don't use both updates with one class...use this for chaining
    [filter setValue:inputImage forKey:@"inputImage"];
    [filter setValue:inputBGImage forKey:@"inputBackgroundImage"];
}
//-------------------------
void ofxCIMultiplyBlendMode::update(CIImage* inputImage, ofTexture tex){ //mix an OF texture and a CI filtered image
