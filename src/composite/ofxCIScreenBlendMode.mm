...
#include "ofxCIScreenBlendMode.h"

void ofxCIScreenBlendMode::loadFilter(){
...
void ofxCIScreenBlendMode::update(ofTexture tex1, ofTexture tex2){ //blend 2 OF textures
...
//------------------------
void ofxCIScreenBlendMode::update(CIImage* inputImage, CIImage* inputBGImage){//don't use both updates with one class...use this for chaining
    [filter setValue:inputImage forKey:@"inputImage"];
    [filter setValue:inputBGImage forKey:@"inputBackgroundImage"];
}
//-------------------------
void ofxCIScreenBlendMode::update(CIImage* inputImage, ofTexture tex){ //mix an OF texture and a CI filtered image
